                ...
                <div class="card">
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            fieldHTML = fieldHTML +
                                '<div class="row"><div class="col-md-12"><div class="field_wrapper"><div class="form-group"><label for="description">Description*</label><textarea name="description[]" id="description" class="form-control" rows="3"></textarea></div></div></div></div>';
                            fieldHTML = fieldHTML +
